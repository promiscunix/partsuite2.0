...
urlpatterns = [
  ...
  path("invoices/fca-parser/", FCAInvoiceParserView.as_view(), name="fca-parser"),
  ...
  path("sales/<int:pk>/items/update/", duebill_items_update, name="sales-items-update"),
